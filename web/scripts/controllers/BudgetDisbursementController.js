angular.module('e-homework').controller('BudgetDisbursementController', function($scope, $cookies, $filter, $state, $uibModal, HTTPService, IndexOverlayFactory) {
    ...
    $scope.createChart = function(Data){
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['งบบุคลากร', 'งบดำเนินงาน', 'งบลงทุน', 'งบเงินอุดหนุน', 'งบรายจ่ายอื่น', 'รวม']/*['ยอดได้รับตาม พ.ร.บ. งบประมาณ', 'งบดำเนินงาน', 'งบลงทุน', 'งบเงินอุดหนุน', 'งบรายจ่ายอื่น', 'รวม']*///["บริการสัตว์แพทย์", "ผสมเทียม", "แร่ธาตุ", "อาหารสัตว์", "ผลิตน้ำเชื้อแช่แข็ง", "จำหน่ายน้ำเชื้อแช่แข็ง", "วัสดุผสมเทียมและอื่นๆ", "ปัจจัยการการเลี้ยงโค", "ฝึกอบรม", "ท่องเที่ยว", "สหกรณ์และปริมาณน้ำนม", "ข้อมูลฝูงโค"],
                ,datasets: [
                {
                    label: 'ยอดได้รับตาม พ.ร.บ. งบประมาณ',
