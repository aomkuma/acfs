angular.module('e-homework').controller('QuestionnaireResponseDetailController', function($scope, $compile, $cookies, $filter, $state, $routeParams, $uibModal, HTTPService, IndexOverlayFactory) {
    ...
    $scope.updateData = function(Questionnaire, ResponseBy){
     ...
     $scope.cancel = function(){
        window.location.href = '#/questionnaire-response';
     }
    ...
    $scope.setQuestionnaire($routeParams.questionnaireID);
