angular.module('e-homework').controller('SeminarResponseController', function($scope, $compile, $cookies, $filter, $state, $routeParams, $uibModal, HTTPService, IndexOverlayFactory) {
    ...
    $scope.saveResponse = function(Data, AttachFile){
        ...
        modalInstance.result.then(function (valResult) {
            ...
            HTTPService.uploadRequest('seminar/response/add', params).then(function(result){
                ...
                window.location.replace('#/seminar/' + $scope.page_type);
    ...
    $scope.Data = {'seminar_id' : $routeParams.id};
    $scope.PAGE = 'MAIN';
