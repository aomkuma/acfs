angular.module('e-homework').controller('StandardCommodityMandatoryController', function($scope, $compile, $cookies, $filter, $state, $uibModal, HTTPService, IndexOverlayFactory) {
